class Lustra::CLI::Migration < Admiral::Command
  ...
  class Up < Admiral::Command
    ...
    def run_impl
      Lustra::Migration::Manager.instance.up arguments.migration_number
    end
  end
  ...
  class Down < Admiral::Command
    ...
    def run_impl
      Lustra::Migration::Manager.instance.down arguments.migration_number
    end
  end
  ...
  class Rollback < Admiral::Command
    ...
    def run_impl
      array = Lustra::Migration::Manager.instance.migrations_up.to_a.sort
      ...
      Lustra::Migration::Manager.instance.apply_to(
        array[-num],
        direction: :down)
    end
  end
