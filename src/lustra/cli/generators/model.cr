    ...
    def run_impl
      ...
      if name
        ...
        g.in_directory "src/models" do
          g.file(model_file, Lustra::CLI::Generator.ecr_to_s("#{__DIR__}/../../../../templates/model/model.cr.ecr", g))
        end

        g.in_directory "src/db/migrations" do
          g.file(migration_file, Lustra::CLI::Generator.ecr_to_s("#{__DIR__}/../../../../templates/model/migration.cr.ecr", g))
        end
      else
