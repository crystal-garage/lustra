module Lustra
  ...
  # Lustra::Enum wrap the enums used in PostgreSQL.
  # See `Lustra.enum` macro helper.
  abstract struct Enum
    include Lustra::Expression::Literal
        ...
        module ::Lustra::Model::Converter::\{{@type}}Converter
          def self.to_column(x) : ::\{{@type}}?
            ...
            when Slice(UInt8)
              ...
              raise Lustra::ErrorMessages.converter_error(x.class.name, "::\{{@type}}")
            end
          end
